...
#### Network Address
1.[network interfaces](obsidian://bookmaster?type=open-book&bid=BdBfSmPfuAscUeLw&aid=a8c2404c-f968-fe66-a8d5-f06db77d2148&page=24)：参考 [network interfaces](obsidian://bookmaster?type=open-book&bid=FTcyhwpUReOpCYuo&aid=9a979fe8-11fc-7efb-ca20-bc39151b31e7&page=24)，这里不是很明白，大概指的是 Linux 下的网络接口配置。
